...
def load_knowledge_base(file_path):
    """
    Load and transform ML4RM JSON data into a format compatible with the chatbot.
    The ML4RM data is structured as a list of chapters, each containing a list of topics.
...
def get_ai_response(question, context):
    ...
    try:
        prompt = f"""
You are an AI Teaching Assistant for Machine Learning for Risk Management (ML4RM).
...
"""
        response = client.chat.completions.create(
            model="gpt-4o",
            messages=[
                {"role": "system", "content": "You are a helpful AI assistant specializing in Machine Learning for Risk Management, answering questions based *only* on the provided context."},
...
# --- Main App Logic ---
st.title("ML4RM AI Teaching Assistant")
